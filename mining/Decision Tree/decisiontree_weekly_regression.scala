...
object mining {
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf().setAppName("Decision Tree AAPL Weekly Depth30 Bins1000 Regression")
    ...
    val data = MLUtils.loadLibSVMFile(sc, "hdfs://hadoopmaster:9000/user/hive/warehouse/libsvm/2Weekly.libsvm")
    ...
    val numClasses = 10 // There are 10 classes in the weekly data
