...
object mining {
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf().setAppName("Decision Tree AAPL Daily Depth30 Bins200")
    ...
    val impurity = "gini" // *** ERROR: GiniAggregator given label 96.71 but requires label < numClasses (= 10). REFORMAT CLASSES TO NUMBERS 0-9
    val maxDepth = 30 // DecisionTree currently only supports maxDepth <= 30
    val maxBins = 1000 // Original: 32
