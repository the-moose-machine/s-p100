...
object mining {
  def main(args: Array[String]) {
    ...
    val conf = new SparkConf().setAppName("Decision Tree AAPL Fortnightly")
    ...
    val data = MLUtils.loadLibSVMFile(sc, "hdfs://hadoopmaster:9000/user/hive/warehouse/libsvm/2Fortnight.libsvm")
    ...
    val numClasses = 5 // There are 5 classes in the fortnightly data
